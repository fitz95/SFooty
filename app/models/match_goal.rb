class MatchGoal < ApplicationRecord
    ...
    belongs_to :team_for_id, class_name: "Team", foreign_key: "team_for_id", optional: true
    belongs_to :team_against_id, class_name: "Team", foreign_key: "team_against_id", optional: true
    belongs_to :user
end
