  ...
  path '/users/{id}' do
      ...
      get 'Retrieves a user' do
        ...
        response '200', 'User found' do
          ...
          let(:id) { User.create(email: 'fitzgeraldnsong@gmail.com', password: 'password123', password_confirmation: 'password123', role: 'client', first_name: 'Fitzgerald', last_name: 'Nsong', username: 'fitznsong', user_photo: 'path/to/photo.jpg').id }
          run_test!
        end
